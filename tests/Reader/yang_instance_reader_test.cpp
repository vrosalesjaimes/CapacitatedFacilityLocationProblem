...
void createTestFileYang(const std::string& filename, const std::string& content) {
...
TEST(YangInstanceReaderTest, ReadInstanceSuccess) {
    ...
    std::string content = "2 3\n"
                          ...
                          "10.0 40.0 60.0\n"
                          "20.0 50.0 70.0";
    createTestFileYang(filename, content);

    YangInstanceReader reader;
...
TEST(YangInstanceReaderTest, ReadInstanceFileNotFound) {
    YangInstanceReader reader;
